        ...
        <div class="min-h-[calc(100svh-6rem-12rem)] py-8">
            <div class="w-full max-w-3xl mx-auto text-center">
                ...
                <p class="mt-4 text-gray-600">
                    Insert your booking code and email address to find your reservation and reschedule it to a new date. The booking code can be found in your order details page.
                </p>
                ...
                {{-- Search Form --}}
                <form class="mt-8 flex flex-col items-center justify-center gap-4" action="{{ route('reschedule') }}" method="GET">
                    <div class="w-full max-w-2xl">
                        <label for="redeem-code" class="block text-sm font-medium text-gray-700 mb-2">Booking Code</label>
                        <input
                            id="redeem-code"
                            type="text"
                            name="code"
                    ...
                    <div class="w-full max-w-2xl">
                        <label for="reschedule-email" class="block text-sm font-medium text-gray-700 mb-2">Email</label>
                        <input
                            id="reschedule-email"
                            type="email"
                            name="email"
